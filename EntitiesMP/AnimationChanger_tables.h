...
EP_ENUMBEG(ChangeAnimType)
  EP_ENUMVALUE(ACTION_NONE, "normal animation"),
  EP_ENUMVALUE(ACTION_SKILL, "skill animation"),
  EP_ENUMVALUE(ACTION_DISAPPEAR, "disappear animation"),
  EP_ENUMVALUE(ACTION_APPEAR, "appear animation"),
EP_ENUMEND(ChangeAnimType);

CEntityEvent *EChangeAnim_New(void) { return new EChangeAnim; };
CDLLEntityEvent DLLEvent_EChangeAnim = {
  0x00da0000, &EChangeAnim_New
};
CDLLEntityEvent *CAnimationChanger_events[] = {
  &DLLEvent_EChangeAnim,
};
#define CAnimationChanger_eventsct ARRAYCOUNT(CAnimationChanger_events)
...
CEntityProperty CAnimationChanger_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_STRING, NULL, (0x000000da<<8)+20, offsetof(CAnimationChanger, m_strModelAnim), "Model Animation (SKA only)", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_FLOAT, NULL, (0x000000da<<8)+21, offsetof(CAnimationChanger, m_fBlendTime), "Blend Time (SKA only)", 0, 0x7F0000FFUL, 0),
};
...
#define MODEL_CHANGER ((0x000000da<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_CHANGER, 2, "EFNM" "Data\\Models\\Editor\\AnimationChanger.mdl"),
#define TEXTURE_CHANGER ((0x000000da<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_CHANGER, 2, "EFNM" "Data\\Models\\Editor\\AnimationChanger.tex"),
};

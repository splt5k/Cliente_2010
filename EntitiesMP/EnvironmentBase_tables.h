...
#line 315 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/EnvironmentBase.es"
Main),DEBUGSTRING("CEnvironmentBase::Main")},
 {0x03840000, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840000_Main_01), DEBUGSTRING("CEnvironmentBase::H0x03840000_Main_01")},
 {0x03840001, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840001_Main_02), DEBUGSTRING("CEnvironmentBase::H0x03840001_Main_02")},
 {0x03840002, -1, CEntity::pEventHandler(&CEnvironmentBase::
#line 336 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/EnvironmentBase.es"
MoveToMarker),DEBUGSTRING("CEnvironmentBase::MoveToMarker")},
 {0x03840003, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840003_MoveToMarker_01), DEBUGSTRING("CEnvironmentBase::H0x03840003_MoveToMarker_01")},
 {0x03840004, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840004_MoveToMarker_02), DEBUGSTRING("CEnvironmentBase::H0x03840004_MoveToMarker_02")},
 {0x03840005, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840005_MoveToMarker_03), DEBUGSTRING("CEnvironmentBase::H0x03840005_MoveToMarker_03")},
 {0x03840006, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840006_MoveToMarker_04), DEBUGSTRING("CEnvironmentBase::H0x03840006_MoveToMarker_04")},
 {0x03840007, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840007_MoveToMarker_05), DEBUGSTRING("CEnvironmentBase::H0x03840007_MoveToMarker_05")},
 {0x03840008, -1, CEntity::pEventHandler(&CEnvironmentBase::
#line 363 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/EnvironmentBase.es"
Activate),DEBUGSTRING("CEnvironmentBase::Activate")},
 {0x03840009, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840009_Activate_01), DEBUGSTRING("CEnvironmentBase::H0x03840009_Activate_01")},
 {0x0384000a, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x0384000a_Activate_02), DEBUGSTRING("CEnvironmentBase::H0x0384000a_Activate_02")},
 {0x0384000b, -1, CEntity::pEventHandler(&CEnvironmentBase::
#line 371 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/EnvironmentBase.es"
Stop),DEBUGSTRING("CEnvironmentBase::Stop")},
 {0x0384000c, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x0384000c_Stop_01), DEBUGSTRING("CEnvironmentBase::H0x0384000c_Stop_01")},
 {0x0384000d, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x0384000d_Stop_02), DEBUGSTRING("CEnvironmentBase::H0x0384000d_Stop_02")},
 {0x0384000e, -1, CEntity::pEventHandler(&CEnvironmentBase::
#line 380 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/EnvironmentBase.es"
DoAction),DEBUGSTRING("CEnvironmentBase::DoAction")},
 {0x0384000f, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x0384000f_DoAction_01), DEBUGSTRING("CEnvironmentBase::H0x0384000f_DoAction_01")},
 {0x03840010, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840010_DoAction_02), DEBUGSTRING("CEnvironmentBase::H0x03840010_DoAction_02")},
 {0x03840011, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840011_DoAction_03), DEBUGSTRING("CEnvironmentBase::H0x03840011_DoAction_03")},
 {0x03840012, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840012_DoAction_04), DEBUGSTRING("CEnvironmentBase::H0x03840012_DoAction_04")},
 {0x03840013, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840013_DoAction_05), DEBUGSTRING("CEnvironmentBase::H0x03840013_DoAction_05")},
 {0x03840014, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840014_DoAction_06), DEBUGSTRING("CEnvironmentBase::H0x03840014_DoAction_06")},
 {0x03840015, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840015_DoAction_07), DEBUGSTRING("CEnvironmentBase::H0x03840015_DoAction_07")},
 {0x03840016, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840016_DoAction_08), DEBUGSTRING("CEnvironmentBase::H0x03840016_DoAction_08")},
 {0x03840017, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840017_DoAction_09), DEBUGSTRING("CEnvironmentBase::H0x03840017_DoAction_09")},
 {0x03840018, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x03840018_DoAction_10), DEBUGSTRING("CEnvironmentBase::H0x03840018_DoAction_10")},
 {0x03840019, -1, CEntity::pEventHandler(&CEnvironmentBase::
#line 406 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/EnvironmentBase.es"
MainLoop),DEBUGSTRING("CEnvironmentBase::MainLoop")},
 {0x0384001a, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x0384001a_MainLoop_01), DEBUGSTRING("CEnvironmentBase::H0x0384001a_MainLoop_01")},
 {0x0384001b, -1, CEntity::pEventHandler(&CEnvironmentBase::H0x0384001b_MainLoop_02), DEBUGSTRING("CEnvironmentBase::H0x0384001b_MainLoop_02")},
};

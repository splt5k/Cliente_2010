...
CEntityEvent *EModel2Activate_New(void) { return new EModel2Activate; };
CDLLEntityEvent DLLEvent_EModel2Activate = {
  0x00d20000, &EModel2Activate_New
};
CEntityEvent *EModel2Deactivate_New(void) { return new EModel2Deactivate; };
CDLLEntityEvent DLLEvent_EModel2Deactivate = {
  0x00d20001, &EModel2Deactivate_New
};
...
EP_ENUMBEG(ShadowType)
  ...
  EP_ENUMVALUE(ST_PROJECTION, "Projection Shadows"),
EP_ENUMEND(ShadowType);

CDLLEntityEvent *CModelHolder2_events[] = {
  &DLLEvent_EModel2Deactivate,
  &DLLEvent_EModel2Activate,
};
#define CModelHolder2_eventsct ARRAYCOUNT(CModelHolder2_events)
...
CEntityProperty CModelHolder2_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_COLOR, NULL, (0x000000d2<<8)+28, offsetof(CModelHolder2, m_colModelColor), "Model Color", 0, 0x7F0000FFUL, 0),
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000d2<<8)+26, offsetof(CModelHolder2, m_bActive), "Active", 0, 0x7F0000FFUL, EPROPF_NETSEND ),
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000d2<<8)+116, offsetof(CModelHolder2, m_bRenderReflection), "Render reflection?", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000d2<<8)+117, offsetof(CModelHolder2, m_bTerrainShadow), "Terrain Shadow?", 0, 0x7F0000FFUL, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000d2<<8)+119, offsetof(CModelHolder2, m_bDecorationObject), "Decoration Object", 0, 0x7F0000FFUL, 0),
};
...
#line 675 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/ModelHolder2.es"
Main),DEBUGSTRING("CModelHolder2::Main")},
 {0x00d20002, -1, CEntity::pEventHandler(&CModelHolder2::H0x00d20002_Main_01), DEBUGSTRING("CModelHolder2::H0x00d20002_Main_01")},
 {0x00d20003, -1, CEntity::pEventHandler(&CModelHolder2::H0x00d20003_Main_02), DEBUGSTRING("CModelHolder2::H0x00d20003_Main_02")},
 {0x00d20004, -1, CEntity::pEventHandler(&CModelHolder2::
#line 819 "D:/LC_2009_Project/lastchaos-source-client-2009/EntitiesMP/ModelHolder2.es"

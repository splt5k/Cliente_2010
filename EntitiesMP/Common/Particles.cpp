...
void InitParticles(void)
{
	try
	{
		_toRomboidTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Romboid.tex"));
		_toBombTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\WhiteBubble.tex"));
		_toFirecrackerTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\FireCracker.tex"));
		_toSpiralTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Smoke01.tex"));
		_toColoredStarsTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Star01.tex"));
		_toFireball01Trail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Fireball01.tex"));
		_toGrenadeTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Smoke02.tex"));
		_toCannonBall.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\CannonBall.tex"));
		_toRocketTrail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Smoke06.tex"));
		_toVerticalGradient.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\VerticalGradient.tex"));
		_toVerticalGradientAlpha.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\VerticalGradientAlpha.tex"));
		_toBlood01Trail.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Blood02.tex"));
		_toLavaTrailGradient.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\LavaTrailGradient.tex"));
		_toLavaTrailSmoke.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\LavaTrailSmoke.tex"));
		_toFlamethrowerTrail01.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\FlameThrower01.tex"));
		_toFlamethrowerTrail02.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\FlameThrower02.tex"));
		_toFire.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\Fire.tex"));
		_toBoubble01.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Boubble01.tex"));
		_toBoubble02.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Boubble02.tex"));
		_toBoubble03.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Boubble03.tex"));
		_toStar01.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star01.tex"));
		_toStar02.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star02.tex"));
		_toStar03.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star03.tex"));
		_toStar04.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star04.tex"));
		_toStar05.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star05.tex"));
		_toStar06.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star06.tex"));
		_toStar07.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star07.tex"));
		_toStar08.SetData_t(CTFILENAME("Data\\Models\\Items\\Particles\\Star08.tex"));
		_toWaterfallGradient.SetData_t(CTFILENAME("Data\\Models\\Effects\\Heatmaps\\Waterfall08.tex"));
		_toGhostbusterBeam.SetData_t(CTFILENAME("Data\\Models\\Weapons\\GhostBuster\\Projectile\\Ray.tex"));
		_toLightning.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Lightning.tex"));
		_toSand.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Sand.tex"));
		_toSandFlowGradient.SetData_t(CTFILENAME("Data\\Models\\Effects\\Heatmaps\\SandFlow01.tex"));
		_toWater.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Water.tex"));
		_toWaterFlowGradient.SetData_t(CTFILENAME("Data\\Models\\Effects\\Heatmaps\\WaterFlow01.tex"));
		_toLava.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Lava.tex"));
		_toLavaFlowGradient.SetData_t(CTFILENAME("Data\\Models\\Effects\\Heatmaps\\LavaFlow01.tex"));
		_toBloodSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Blood03.tex"));
		_toFlowerSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Flowers.tex")); 
		_toBonesSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BonesSpill01.tex"));
		_toFeatherSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\FeatherSpill01.tex"));
		_toStonesSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\StonesSpill01.tex"));
		_toLavaSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\LavaSpill01.tex"));
		//_toBeastProjectileSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastProjectileSpill.tex"));
		_toLavaEruptingTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\LavaErupting.tex"));
		_toWoodSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\WoodSpill01.tex"));
		_toTreeSprayTexture.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\TreeSpill01.tex"));
		_toLavaBombTrailSmoke.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\LavaBomb.tex"));
		_toLavaBombTrailGradient.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\LavaBombGradient.tex"));
		//_toBeastDebrisTrailGradient.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastDebrisTrailGradient.tex"));
		//_toBeastProjectileTrailTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastProjectileTrail.tex"));
		//_toBeastProjectileTrailGradient.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastProjectileTrailGradient.tex"));
		//_toBeastBigProjectileTrailTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastBigProjectileTrail.tex"));
		//_toBeastBigProjectileTrailGradient.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastBigProjectileTrailGradient.tex"));
		//_toBeastDebrisTrailTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BeastDebrisTrail.tex"));
		_toElectricitySparks.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\ElectricitySparks.tex"));
		_toRaindrop.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Raindrop.tex"));
		_toSnowdrop.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\Snowdrop.tex"));
		_toBulletStone.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BulletSpray.tex"));
		_toBulletWater.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BulletSprayWater.tex"));
		_toBulletSand.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BulletSpraySand.tex"));
		_toBulletSpark.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\BulletSpark.tex"));
		_toBulletSmoke.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\SmokeAnim01.tex"));
		_toPlayerParticles.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\PlayerParticles.tex"));
		_toWaterfallFoam.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\WaterfallFoam.tex"));
		_toMetalSprayTexture.SetData_t(CTFILENAME("Data\\Textures\\Effects\\Particles\\MetalSpill.tex"));
		_toBulletGrass.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\BulletSprayGrass.tex"));
		_toBulletWood.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\BulletSprayWood.tex"));
		_toBulletSnow.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\BulletSpraySnow.tex"));
		_toAirSprayTexture.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\AirSpray.tex"));
		_toFlameThrowerGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\FlameThrowerGradient.tex"));
		_toFlameThrowerStartGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\FlameThrowerStartGradient.tex"));
//		_toSpawnerProjectile.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\SpawnerProjectile.tex"));
		_toExplosionDebris.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\ExplosionDebris.tex"));
		_toExplosionDebrisGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\ExplosionDebrisGradient.tex"));
		_toExplosionSpark.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\ExplosionSpark.tex"));
		_toChimneySmoke.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\ChimneySmoke.tex"));
//		_toTwister.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\Twister.tex"));
		_toChimneySmokeGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\ChimneySmokeGradient.tex"));
		_toWaterfallGradient2.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\WaterfallFoamGradient.tex"));
		_toAfterBurner.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\AfterBurner.tex"));
		_toAfterBurnerHead.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\AfterBurnerHead.tex"));
		_toAfterBurnerGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\AfterBurnerGradient.tex"));
		_toAfterBurnerGradientBlue.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\AfterBurnerGradientBlue.tex"));
		_toAfterBurnerGradientMeteor.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\AfterBurnerGradientMeteor.tex"));
//		_toTwisterGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\TwisterGradient.tex"));
		_toWaterfallFoam2.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\WaterfallFoam.tex"));
		_toLarvaLaser.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\LarvaLaser.tex"));
		_toLarvaProjectileSpray.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\PlasmaProjectileSpill.tex"));
		_toGrowingTwirl.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\GrowingTwirl.tex"));
		//_toSummonerDisappearGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\SummonerDisappearGradient.tex"));
		//_toSummonerStaffGradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\SummonerStaffGradient.tex"));
//		_toFireworks01Gradient.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\Fireworks01Gradient.tex"));
		_toSEStar01.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\Star01.tex"));
		_toMeteorTrail.SetData_t(CTFILENAME("Data\\TexturesMP\\Effects\\Particles\\MeteorTrail.tex"));
	...
	while (eph != NULL)
	{
		...
		if (boxViewer.HasContactWith(boxViewTreshold)) {
			...
			case EPTH_RAIN: {
				...
				{
					eph->GetHeightMapData( ptdTerrainMap, boxTerrainMap);
					Particles_Rain( penView, eph, 1.25f, fRainFactor, ptdTerrainMap, boxTerrainMap);
				}
				break; }
			...
			case EPTH_SNOW: {
				...
				{
					eph->GetHeightMapData( ptdTerrainMap, boxTerrainMap);
					Particles_Snow( penView, eph, 2.0f, fSnowFactor, ptdTerrainMap, boxTerrainMap, eph->m_tmSnowStart);
				}
				break; }
...
void DECL_DLL Particles_Waterfall(CEntity *pen, INDEX ctCount, FLOAT fStretchAll, FLOAT fStretchX, FLOAT fStretchY,
																	...
																	FLOAT fParam1, FLOAT fParam2, COLOR cColor)
{
	FLOAT fMipFactor = Particle_GetMipFactor();
	if( fMipFactor>fMipDisappearDistance) return;
	FLOAT fMipBlender=CalculateRatio(fMipFactor, 0.0f, fMipDisappearDistance, 0.0f, 0.1f);
	...
	for(INDEX i=0; i<ctCount; i++)
	{
		...
		// apply time strech
		//fT *= 1/fParam1;
		//Param2값으로 떨어지는 속도 달라지게 변경	:Su-won
		...
		//COLOR colCombined=(col&0xFFFFFF00)|ubA;
		COLOR colCombined=(col&cColor)|ubA;		//Color 속성값을 색을 변경할 수 있게 수정:Su-won
...
{
	// get blood type
	const INDEX iBloodType = gam_iBlood;//GetSP()->sp_iBlood;
...
void Particles_Spiral( CEntity *pen, FLOAT fSize, FLOAT fHeight,
											enum ParticleTexture ptTexture, INDEX ctParticles, FLOAT fSpeed)
{
	ASSERT( ctParticles<=CT_MAX_PARTICLES_TABLE);
	...
	{
		//FLOAT fT = fNow+afTimeOffsets[iStar];
		//fParam2값(fSpeed)으로 속도 조절되도록 수정	:Su-won
...
void Particles_Emanate( CEntity *pen, FLOAT fSize, FLOAT fHeight,
											 ...
											 COLOR cColor, FLOAT fDirection, FLOAT fSpeed, FLOAT fPSize)
{
	ASSERT( ctParticles<=CT_MAX_PARTICLES_TABLE);
	...
	for( INDEX iStar=0; iStar<ctParticles; iStar++)
	{
		...
		//Param2(fSpeed)값으로 속도 조절되도록 수정	:Su-won
		fT *= 1/fSpeed;
		...
		*****///=====>
		// fParam1(fDirection)값이 1이면 안쪽으로 모아지고 1이 아니면 원래처럼 바깥으로 퍼지게 수정 :Su-won
		FLOAT3D vPos;
		if( fDirection!=1)
		{
			vPos = vCenter+FLOAT3D(
			afStarsPositions[iStar][0], 
			afStarsPositions[iStar][1],
			afStarsPositions[iStar][2])*fSize*(fF+0.4f);
		}
		...
		//Param3(fPSize)값으로 파티클 크기, Color값으로 파티클 색깔 조절되게 수정	:Su-won
...
//안태훈 수정 시작	//(Modify Original Sam Effect)(0.1)
void Particles_RunningDust(CEntity *pen)
{
	...
	for(INDEX iPos = 2; iPos<plp->lp_ctUsed; iPos++)
	{
		...
		FLOAT fLifeTime = 2.8f-(afStarsPositions[iRnd][1]+0.5f)*1.0f;	fLifeTime *= 0.3f;

		FLOAT fT = _pTimer->GetLerpedCurrentTick()-tmStarted;
		FLOAT fRatio = CalculateRatio(fT, 0, fLifeTime, 0.1f, 0.25f);

		FLOAT fRndAppearX = afStarsPositions[iRnd][0]*1.0f;			fRndAppearX *= 0.2f;
		FLOAT fRndSpeedY = (afStarsPositions[iRnd][1]+0.5f)*0.5f;	fRndSpeedY *= 0.1f;
		FLOAT fRndAppearZ = afStarsPositions[iRnd][2]*1.0f;			fRndAppearZ *= 0.2f;
		vPos(1) += fRndAppearX; 
		vPos(2) += (0.5f+fRndSpeedY)*fT; 
		vPos(3) += fRndAppearZ; 

		FLOAT fRndBlend = 8.0f+(afStarsPositions[iRnd*2][1]+0.5f)*64.0f;	//fRndBlend = 1.0f;
...
//안태훈 수정 끝	//(Modify Original Sam Effect)(0.1)
...
void Particles_Rain(CEntity *pen, CEnvironmentParticlesHolder* eph, FLOAT fGridSize, FLOAT fFactor,
										CTextureData *ptdRainMap, FLOATaabbox3D &boxRainMap)
{
	INDEX ctGrids =eph->m_iParticleCount;
	...
	// EnvironmentParticleHolder의 'Particle Texture' 속성으로 설정한 텍스쳐를 파티클에 사용
	if( eph->m_fnTexture != CTString(""))
		Particle_PrepareTexture(&(eph->m_moParticleTextureHolder.mo_toTexture), PBT_BLEND);
	// 'Particle Texture' 속성을 설정하지 않으면 기본 텍스쳐 사용
	else
	...
	for( INDEX iZ=0; iZ<ctGrids; iZ++)
	{
		...
		for( INDEX iX=0; iX<ctGrids; iX++)
		{
			...
			FLOAT fRatio = (fNow*(1+0.1f*afStarsPositions[iRndZ][2])+fT0)/(RAIN_DROP_TIME) *eph->m_vDropSpeed;
...
//안태훈 수정 시작	//(Add & Modify SSSE Effect)(0.1)
			//비의 색깔 관련 코드 수정, 원래 코드대로 하면 검은비가 내림.
...
//안태훈 수정 끝	//(Add & Modify SSSE Effect)(0.1)
			...
			vRender(1) += -vRender(2) *eph->m_vWindX  +(RAIN_SOURCE_HEIGHT*eph->m_vWindX/2);
			vRender(3) += vRender(2) *eph->m_vWindZ -(RAIN_SOURCE_HEIGHT*eph->m_vWindX/2);
			
			FLOAT3D vTarget = vRender+FLOAT3D( eph->m_vWindX, -fSize, -eph->m_vWindZ);
			Particle_RenderLine( vTarget, vRender, 0.0125f *eph->m_fParticleSize, colDrop);
		}
	}
	// all done
	Particle_Flush();
...
void Particles_Snow(CEntity *pen, CEnvironmentParticlesHolder* eph, FLOAT fGridSize, FLOAT fFactor,
										CTextureData *ptdSnowMap, FLOATaabbox3D &boxSnowMap, FLOAT fSnowStart)
{
	...
	float Snow_Tile_Drop_Time = SNOW_TILE_DROP_TIME/(eph->m_vDropSpeed+0.001f);
	...
	for( INDEX iZ=0; iZ<ctGrids; iZ++)
	{
		...
		for( INDEX iX=0; iX<ctGrids; iX++)
		{
			...
			for( INDEX iY=0; iY<(YGRIDS_VISIBLE_ABOVE+YGRIDS_VISIBLE_BELOW); iY++)
			{
				...
				vRender(1) += -vRender(2) *eph->m_vWindX +(YGRID_SIZE*eph->m_vWindX/2);
				vRender(3) += vRender(2) *eph->m_vWindZ -(YGRID_SIZE*eph->m_vWindX/2);

				Particle_RenderSquare( vRender, fSize*eph->m_fParticleSize, fAngle, colDrop);
			}
		}
	}
	// all done
...
void Particles_EmptyShells( CEntity *pen, ShellLaunchData *asldData)
{
	...
	CMovableEntity* penEntity = (CMovableEntity *)pen;
	if (!_pNetwork->IsServer() && penEntity->IsFlagOn(ENF_ALIVE)) {
		penEntity->TestFields(penEntity->en_iUpContent,penEntity->en_iDnContent,penEntity->en_fImmersionFactor);
	}
	FLOAT tmNow = _pTimer->GetLerpedCurrentTick();
	FLOAT fGA = penEntity->en_fGravityA;
	FLOAT3D vGDir = penEntity->en_vGravityDir;
	INDEX iRow, iColumn;
...
//안태훈 수정 끝	//(Add & Modify SSSE Effect)(0.1)
	...
	FLOAT tmNow;
	// player entities should use en_tmEntityTime instead of current tick to determine end time
	if (pen->IsPlayer()) {
		FLOAT fLerpFactor = _pTimer->GetLerpFactor();
		tmNow = ((CPlayerEntity*)pen)->en_tmEntityTime + fLerpFactor * _pTimer->TickQuantum;
	} else {
		tmNow = _pTimer->GetLerpedCurrentTick();
	}

	FLOAT fTime = tmNow-tmStart;
	// don't render particles before fade in and after fadeout
...
void Particles_Twister( CEntity *pen, FLOAT fStretch, FLOAT fStartTime, FLOAT fFadeOutStartTime, FLOAT fParticleStretch)
{
	...
	for(INDEX i=0; i<ctSmokes; i++)
	{
		...
		FLOAT3D vPos=vCenter+vY*fSpeed*fT+
			vX*(fR*Sin(fT*360.0f*16.0f))+
			vZ*(fR*Cos(fT*360.0f*16.0f));
		FLOAT fT2=fT+0.05f*(0.5f+fT);
		FLOAT3D vPos2=vCenter+vY*fSpeed*fT2+
			vX*(fR*Sin(fT2*360.0f*16.0f))+
			vZ*(fR*Cos(fT2*360.0f*16.0f));
...
void Particles_Windblast( CEntity *pen, FLOAT fStretch, FLOAT fFadeOutStartTime)
{
	...
	for(INDEX i=0; i<ctSmokes; i++)
	{
		...
		FLOAT3D vPos=vCenter+vX*fSpeed*fT+
			vY*(fR*Sin(fT*360.0f*16.0f))+
			vZ*(fR*Cos(fT*360.0f*16.0f));
		FLOAT fT2=fT+0.05f*(0.5f+fT);
		FLOAT3D vPos2=vCenter+vX*fSpeed*fT2+
			vY*(fR*Sin(fT2*360.0f*16.0f))+
			vZ*(fR*Cos(fT2*360.0f*16.0f));
		FLOAT fSize=3.0f;
		if( iFrame>3)
		{
...
void Particles_CollectEnergy(CEntity *pen, FLOAT tmStart, FLOAT tmStop, BOOL bCloudFx)
{
	Particle_PrepareTexture( &_toElectricitySparks, PBT_BLEND);
	Particle_SetTexturePart( 512, 1024, 0, 0);
	FLOAT3D vCenter = pen->GetLerpedPlacement().pl_PositionVector;
...
/*void ParticlesClouds(CParticleCloudsHolder *ppch, CTextureObject &to, INDEX ctTilesPerX, INDEX ctTilesPerY)
{
	BOOL bDisableStreaks=FALSE;
	CTextureObject &toStreaks=ppch->m_moStreaksParticleTextureHolder.mo_toTexture;
	CTextureData *ptdStreaks=(CTextureData *) toStreaks.GetData();
	if(ptdStreaks==NULL) bDisableStreaks=TRUE;

	FLOAT3D vBV=ppch->GetPlacement().pl_PositionVector;
	Particle_PrepareTexture( &to, PBT_BLEND);

	CTextureData *ptd = (CTextureData *) to.GetData();
	PIX pixTileW=ptd->GetPixWidth()/ctTilesPerX;
	PIX pixTileH=ptd->GetPixHeight()/ctTilesPerY;

	CParticleCloudsMarker *ppcm=(CParticleCloudsMarker *)&*ppch->m_penParticleCloudsMarker;
	CStaticStackArray<CStreak> aStreaks;
	aStreaks.SetAllocationStep(100);
	while(ppcm!=NULL)
	{
		FLOAT fStreaksConeRatio=1.0f-(ppcm->m_fStreaksConePercentage/100.0f);
		if( ppcm->m_bVisible)
		{
			for( INDEX iCloud=0; iCloud<ppcm->m_ctCount; iCloud++)
			{
				INDEX iRnd1=(ppcm->m_iRndBase+iCloud*1)%CT_MAX_PARTICLES_TABLE;
				INDEX iRnd2=(ppcm->m_iRndBase+iCloud*2)%CT_MAX_PARTICLES_TABLE;
				INDEX iRndStreak=(ppcm->m_iRndBase+iCloud*3)%CT_MAX_PARTICLES_TABLE;
				FLOAT fFrameFreq=0.0f;
				if(ppcm->m_fFramePeriod!=0.0f)
				{
					fFrameFreq=(1.0f+afStarsPositions[iRnd1][2])/ppcm->m_fFramePeriod;
				}
				FLOAT fRndFrameTimeOffset=0.5f+afStarsPositions[iRnd1][1];
				FLOAT tmTime=_pTimer->GetLerpedCurrentTick()*fFrameFreq+fRndFrameTimeOffset*4.0f;
				FLOAT fFract=tmTime-INDEX(tmTime);
				INDEX iFrame=ppcm->m_iFrameStart+INDEX(tmTime)%(ppcm->m_iFrameEnd-ppcm->m_iFrameStart+1);
				INDEX iNextFrame=ppcm->m_iFrameStart+(iFrame-ppcm->m_iFrameStart+1)%(ppcm->m_iFrameEnd-ppcm->m_iFrameStart+1);
				UBYTE ubFade=Clamp(CalculateRatio(fFract,0.0f,1.0f,0.0f,0.5f), 0.0f, 1.0f)*255;
				UBYTE ubNextFade=Clamp(CalculateRatio(fFract,0.0f,1.0f,0.5f,0.0f), 0.0f, 1.0f)*255;
				FLOAT fRndRad=Lerp(ppcm->m_fRadiusMin,ppcm->m_fRadiusMax,afStarsPositions[iRnd1][3]+0.5f)+ppcm->m_fExtraCurvature;
		
				FLOAT fRndRotSpeed=0.0f;
				if(ppcm->m_fRotPeriod!=0.0f)
				{
					fRndRotSpeed=(1.0f+afStarsPositions[iRnd2][1]*1.75f)/(-ppcm->m_fRotPeriod);
				}
				FLOAT fRndH=afStarsPositions[iRnd2][2]*360.0f;
				FLOAT fRndP=ppcm->m_fPitchMin+(afStarsPositions[iRnd2][3]+0.5f)*(ppcm->m_fPitchMax-ppcm->m_fPitchMin);
				FLOAT fH=fRndH+(_pTimer->GetLerpedCurrentTick()-ppcm->m_fRotPeriod)*fRndRotSpeed*360.0f;
				FLOAT fsh=Sin(fH);
				FLOAT fch=Cos(fH);
				FLOAT fsp=Sin(fRndP);
				FLOAT fcp=Cos(fRndP);

				FLOAT fRndSize1=ppcm->m_fSize*(1.0f+afStarsPositions[iRnd1+iFrame][1]*ppcm->m_fRndSizingRatio);
				FLOAT fRndSize2=ppcm->m_fSize*(1.0f+afStarsPositions[iRnd1+iNextFrame][1]*ppcm->m_fRndSizingRatio);
				ClampDn(fRndSize1,0.001f);
				ClampDn(fRndSize2,0.001f);
				FLOAT fSize=Lerp(fRndSize1,fRndSize2,fFract);
				FLOAT3D v0=FLOAT3D(-fSize/2.0f, +fSize/2.0f, -fRndRad);
				FLOAT3D v1=FLOAT3D(-fSize/2.0f, -fSize/2.0f, -fRndRad);
				FLOAT3D v2=FLOAT3D(+fSize/2.0f, -fSize/2.0f, -fRndRad);
				FLOAT3D v3=FLOAT3D(+fSize/2.0f, +fSize/2.0f, -fRndRad);

				FLOAT fColRnd1=0.5f+afStarsPositions[iRnd2+iFrame][2];
				FLOAT fColRnd2=0.5f+afStarsPositions[iRnd2+iNextFrame][2];
				COLOR colRnd1=LerpColor(ppcm->m_colMultiply1,ppcm->m_colMultiply2,fColRnd1);
				COLOR colRnd2=LerpColor(ppcm->m_colMultiply1,ppcm->m_colMultiply2,fColRnd2);
				COLOR colMultiply=LerpColor(colRnd1,colRnd2,fFract);

				// claculate rotation coefficients
				FLOAT c0=fch;
				FLOAT c1=fsp*fsh;
				FLOAT c2=fcp*fsh;
				FLOAT c3=0;
				...
				// roteate vertices
				//v0
				FLOAT frv0x=c0*v0(1)+c1*v0(2)+c2*v0(3);
				FLOAT frv0y=c3*v0(1)+c4*v0(2)+c5*v0(3);
				FLOAT frv0z=c6*v0(1)+c7*v0(2)+c8*v0(3);
				//v1
				FLOAT frv1x=c0*v1(1)+c1*v1(2)+c2*v1(3);
				FLOAT frv1y=c3*v1(1)+c4*v1(2)+c5*v1(3);
				FLOAT frv1z=c6*v1(1)+c7*v1(2)+c8*v1(3);
				//v2
				FLOAT frv2x=c0*v2(1)+c1*v2(2)+c2*v2(3);
				FLOAT frv2y=c3*v2(1)+c4*v2(2)+c5*v2(3);
				FLOAT frv2z=c6*v2(1)+c7*v2(2)+c8*v2(3);
				//v3
				FLOAT frv3x=c0*v3(1)+c1*v3(2)+c2*v3(3);
				FLOAT frv3y=c3*v3(1)+c4*v3(2)+c5*v3(3);
				FLOAT frv3z=c6*v3(1)+c7*v3(2)+c8*v3(3);

				// render rotated current particle
				FLOAT3D vr0=vBV+FLOAT3D(frv0x,frv0y-ppcm->m_fExtraCurvature,frv0z);
				FLOAT3D vr1=vBV+FLOAT3D(frv1x,frv1y-ppcm->m_fExtraCurvature,frv1z);
				FLOAT3D vr2=vBV+FLOAT3D(frv2x,frv2y-ppcm->m_fExtraCurvature,frv2z);
				FLOAT3D vr3=vBV+FLOAT3D(frv3x,frv3y-ppcm->m_fExtraCurvature,frv3z);

				if( ppcm->m_bRenderClouds)
				{
					Particle_SetTexturePart( pixTileW, pixTileH, iFrame%ctTilesPerY, iFrame/ctTilesPerY);
					Particle_RenderQuad3D(vr0, vr1, vr2, vr3, MulColors(C_WHITE|ubFade, colMultiply));

					// render rotated next particle
					Particle_SetTexturePart( pixTileW, pixTileH, iNextFrame%ctTilesPerY, iNextFrame/ctTilesPerY);
					Particle_RenderQuad3D(vr0, vr1, vr2, vr3, MulColors(C_WHITE|ubNextFade, colMultiply));
				}

				// ------- Streaks
				// no streaks if no sun or no streaks texture available
				if(ppcm->m_penSun==NULL || bDisableStreaks) continue;

				// get sun pos
				FLOAT3D vSunPos=ppcm->m_penSun->GetPlacement().pl_PositionVector;        
				// see if we should render streak for this cloud
				FLOAT3D vCloudPos=(vr0+vr2)/2.0f;
				FLOAT3D vCloudNormal=(vr2-vr1)*(vr0-vr1);
				FLOAT3D vSunCloud=vCloudPos-vSunPos;
				vCloudNormal.Normalize();
				vSunCloud.Normalize();
				FLOAT fStreakAngle=vSunCloud%vCloudNormal;
				// if streak is visible
				if(fStreakAngle>fStreaksConeRatio)
				{
					for( INDEX iStreak=0; iStreak<ppcm->m_ctStreaksPerCloud; iStreak++)
					{
						FLOAT fStreakPower=(fStreakAngle-fStreaksConeRatio)/(1.0f-fStreaksConeRatio);
						// get size direction
						FLOAT3D vSizeDir=vSunCloud*(vCloudPos-vBV);
						vSizeDir.Normalize();
						// add streak
						CStreak &sk=aStreaks.Push();
						FLOAT fRndStreakSize1=ppcm->m_fStreakSize*(1.0f+afStarsPositions[iRndStreak+iFrame+iStreak][1]*ppcm->m_fRndStreakSize);
						FLOAT fRndStreakSize2=ppcm->m_fStreakSize*(1.0f+afStarsPositions[iRndStreak+iNextFrame+iStreak][1]*ppcm->m_fRndStreakSize);
						ClampDn(fRndStreakSize1,0.001f);
						ClampDn(fRndStreakSize2,0.001f);
						FLOAT fRndStreakSize=Lerp(fRndStreakSize1,fRndStreakSize2,fFract);
						FLOAT fRndStreakPower=(0.5f+afStarsPositions[iRndStreak][2]);
						COLOR colRndPower=LerpColor(ppcm->m_colStreaksMin,ppcm->m_colStreaksMax,fRndStreakPower);
						fStreakPower*=1.0f-(1.0f+
							sin((_pTimer->GetLerpedCurrentTick()+afStarsPositions[iRndStreak+iFrame+iStreak][3]*
							ppcm->m_fStreakPulsatingPeroid*2.0f)))/2.0f*ppcm->m_fStreakPulsatingRatio;
						ClampDn(fStreakPower,0.0f);
						sk.sk_colStreak=LerpColor(C_BLACK|CT_TRANSPARENT,colRndPower,fStreakPower);
						// get streaks start position
						FLOAT3D vNormX=(vr3-vr0).Normalize();
						FLOAT3D vNormY=(vr1-vr0).Normalize();
						FLOAT3D vRndPos1=vCloudPos+
							vNormX*afStarsPositions[iRndStreak+iFrame+iStreak+1][1]*fSize*ppcm->m_fStreaksRndMovementRatio+
							vNormY*afStarsPositions[iRndStreak+iFrame+iStreak+1][2]*fSize*ppcm->m_fStreaksRndMovementRatio;
						FLOAT3D vRndPos2=vCloudPos+
							vNormX*afStarsPositions[iRndStreak+iNextFrame+iStreak+1][1]*fSize*ppcm->m_fStreaksRndMovementRatio+
							vNormY*afStarsPositions[iRndStreak+iNextFrame+iStreak+1][2]*fSize*ppcm->m_fStreaksRndMovementRatio;
						FLOAT3D vRndPos=Lerp(vRndPos1,vRndPos2,fFract);
						sk.sk_av[0]=vRndPos-vSizeDir*(fRndStreakSize/2.0f);
						sk.sk_av[3]=vRndPos+vSizeDir*(fRndStreakSize/2.0f);
						FLOAT fSunY=vSunPos(2)-vBV(2);
						FLOAT3D v0 = (sk.sk_av[0]-vSunPos);
						FLOAT3D v3 = (sk.sk_av[3]-vSunPos);
						sk.sk_av[1]=vSunPos+v0*(fSunY/fabs(v0(2)));
						sk.sk_av[2]=vSunPos+v3*(fSunY/fabs(v3(2)));
					}
				}
			}
		}
		// render next clouds particle marker
		ppcm=(CParticleCloudsMarker *)&*ppcm->m_penNextParticleCloudsMarker;
	}
	Particle_Flush();

	if(bDisableStreaks) return;

	// render streaks
	ParticleBlendType iBlendMode=PBT_ADD;
	switch(ppch->m_sbtStreaksBelndType)
	{
		case SBT_BLEND:       iBlendMode=PBT_BLEND;       break;
		case SBT_ADD:         iBlendMode=PBT_ADD;         break;
		case SBT_MULTIPLY:    iBlendMode=PBT_MULTIPLY;    break;
		case SBT_ADDALPHA:    iBlendMode=PBT_ADDALPHA;    break;
		case SBT_FLEX:        iBlendMode=PBT_FLEX;        break;
		case SBT_TRANSPARENT: iBlendMode=PBT_TRANSPARENT; break;
	}

	Particle_PrepareTexture( &toStreaks, iBlendMode);
	Particle_SetTexturePart( ptdStreaks->GetWidth(), ptdStreaks->GetHeight(), 0, 0);
	for(INDEX iStreak=0; iStreak<aStreaks.Count(); iStreak++)
	{
		CStreak &sk=aStreaks[iStreak];
		Particle_RenderQuad3D(sk.sk_av[0], sk.sk_av[1], sk.sk_av[2], sk.sk_av[3], sk.sk_colStreak);
	}
	Particle_Flush();
}*/

...
CDLLEntityEvent *CCamera_events[] = {NULL};
#define CCamera_eventsct 0
...
CEntityProperty CCamera_properties[] = {
 ...
 CEntityProperty(CEntityProperty::EPT_ENTITYPTR, NULL, (0x000000dc<<8)+39, offsetof(CCamera, m_penTargetOld), "", 0, 0, 0),
 ...
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000dc<<8)+82, offsetof(CCamera, m_bStopLerp), "", 0, 0, 0),
 CEntityProperty(CEntityProperty::EPT_BOOL, NULL, (0x000000dc<<8)+83, offsetof(CCamera, bPlayedCamera), "", 0, 0, 0),
};
...
#define MODEL_CAMERA ((0x000000dc<<8)+1)
 CEntityComponent(ECT_MODEL, MODEL_CAMERA, 2, "EFNM" "Data\\Models\\Editor\\Camera.mdl"),
#define TEXTURE_CAMERA ((0x000000dc<<8)+2)
 CEntityComponent(ECT_TEXTURE, TEXTURE_CAMERA, 2, "EFNM" "Data\\Models\\Editor\\Camera.tex"),
};

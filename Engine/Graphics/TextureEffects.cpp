...
{
	// This makes this function different from InitializeFire so compiler does not join them in one function
	volatile INDEX a=0;
...
static void RenderWater(void)
{
	...
	CopyLongs( (ULONG*)pswHeightMap, (ULONG*)(pswHeightMap+(_pixBufferHeight*_pixBufferWidth)), 
						 _pixBufferWidth * sizeof(SWORD)*2/sizeof(ULONG));
...
/////////////////////////////////// move fire
	...
	static SLONG _slDensity = slDensity; // fix for EBX frame pointer
